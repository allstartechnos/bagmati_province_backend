<form action="{{ route($base_route . 'update', $client->id) }}" method="POST" enctype="multipart/form-data"
    class="main_form">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input type="text" name="title" class="form-control title" value="{{ $client->title ?? '' }}"
        ...
        <div class="col-md-6 mb-3">
            <div class="d-flex justify-content-between align-items-center image dropify-wrapper">
                ...
                <input name="image" class="form-control my-2 me-2 file-input custom-file-input" type="file"
                    id="formFile3">
                @if ($client->image)
                    <img src="{{ asset($img_path . $client->image) }}" width="20%"
        ...
        <div class="col-md-12 mb-3">
            <div class="form-floating">
                <input type="text" name="url" class="form-control url" value="{{ $client->url ?? '' }}"
                    id="floatingName" placeholder="url">
                <label for="floatingName">Counter No</label>
            </div>
        </div>
