                ...
                <div class="modal fade" id="view" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body render_contact_show">
            ...
            <div class="card custom-card overflow-hidden border px-2">
                ...
                <form action="{{ route($base_route . 'store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-title">{!! isset($data['contact']) ? '<i class="ri-edit-2-fill"></i>' : '<i class="ri-add-large-fill"></i>' !!}
                            {{ isset($data['contact']) ? 'Update' : 'Create' }}
                            {{ $panel ?? '' }}(Page)</h6>
                        <hr />
                        ...
                        <div class="tab-content" id="profile-tabs">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="title"
                                            value="{{ isset($data['contact']->title) ? $data['contact']->title : old('title') }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="sub_title"
                                            value="{{ isset($data['contact']->sub_title) ? $data['contact']->sub_title : old('sub_title') }}"
                                ...
                                <div class="col-md-12 mb-3 image">
                                    ...
                                    <div class="form-group">
                                        <div class="image dropify-wrapper">
                                            @if (!empty($data['contact']->image))
                                                <img src="{{ asset($img_path . $data['contact']->image) }}" alt=""
                            ...
                            <div class="tab-pane p-0 border-0 py-3" id="social-media-pane" role="tabpanel"
                                ...
                                <textarea name="description" class="form-control summernote" id="editor3">{{ isset($data['contact']->description) ? $data['contact']->description : old('description') }}</textarea>
                            </div>
                            ...
                            <div class="tab-pane p-0 border-0" id="banner-pane" role="tabpanel"
                                ...
                                <div class="col-md-12 mb-3 image">
                                    ...
                                    <div class="form-group">
                                        <div class="image dropify-wrapper">
                                            @if (!empty($data['contact']->banner))
                                                <img src="{{ asset($img_path . $data['contact']->banner) }}"
                                                    class="previewImage" width="100%">
                                            @else
                                                <img src="{{ asset('no_image.jpg') }}" alt=""
                                                    class="previewImage" width="100%">
                            ...
                            <div class="tab-pane p-0 border-0" id="reset-password-pane" role="tabpanel"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="seo_title"
                                            value="{{ isset($data['contact']) ? $data['contact']->seo_title : '' }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="seo_keyword"
                                            value="{{ isset($data['contact']) ? $data['contact']->seo_keyword : '' }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <textarea name="seo_description" value="" class="form-control" placeholder="Seo Description">{{ isset($data['contact']) ? $data['contact']->seo_description : '' }}</textarea>
                            ...
                            <button type="submit" data-button="page"
                                class="formButton btn btn-{{ isset($data['contact']) ? 'danger' : 'primary' }} text-center mx-auto btn-w-md d-flex align-items-center justify-content-center btn-wave waves-light text-nowrap waves-effect waves-light"
                                data-bs-toggle="modal" data-bs-target="#create-folder">
                                {!! isset($data['contact']) ? '<i class="ri-edit-2-fill p-1"></i>' : '<i class="ri-add-large-fill p-1"></i>' !!}
                                {{ isset($data['contact']) ? 'Update' : 'Create' }}
        ...
        <div class="modal fade" id="edit" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body render_contact_edit">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-contact', function() {
                ...
                // let url = "{{ route('admin.contact.show', ':id') }}"; 
            ...
            $(document).on('click', '.edit-contact', function() {
                ...
                let url = "{{ route('admin.contact.edit', ':id') }}";
                url = url.replace(':id', id);
                // let url = "{{ url('/admin/contact') }}/" + id;
