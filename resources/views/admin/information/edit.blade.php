<form action="{{ route($base_route . 'update', $information->id) }}" method="POST" enctype="multipart/form-data"
    class="main_form">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input type="text" name="title" class="form-control title" value="{{ $information->title ?? '' }}"
        ...
        <div class="col-md-6 mb-3">
            <div class="d-flex justify-content-between align-items-center image dropify-wrapper">
                ...
                @if ($information->image)
                    <img src="{{ asset($img_path . $information->image) }}" width="20%"
