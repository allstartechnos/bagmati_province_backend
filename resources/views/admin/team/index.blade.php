    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="d-flex justity-content-between">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#add-board"><i
                                class="ri-add-circle-line px-3 ms-auto text-success" title="Add Post"
                                style="font-size: 26px;"></i></a>

                        <a href="{{ route('admin.team.soft_delete') }}" id="total_count"
                            class="btn btn-m btn-icon btn-danger-light position-relative"><i
                                class="ri-delete-bin-line fs-5 mb-2"></i><span
                                class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                                {{ $data['trashed_count'] ?? '0' }}
                        </a>
                ...
                <div class="modal fade" id="view" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body render_team_show">
        ...
        <div class="col-lg-5">
            <div class="card custom-card overflow-hidden border px-2">
                {{-- @if (isset($data['team']))
                    <form action="{{ route($base_route . 'update', $data['team']->id) }}" method="POST"
                ...
                <form action="{{ route($base_route . 'store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-title">{!! isset($data['team']) ? '<i class="ri-edit-2-fill"></i>' : '<i class="ri-add-large-fill"></i>' !!}
                            {{ isset($data['team']) ? 'Update' : 'Create' }}
                            {{ $panel ?? '' }}(Page)</h6>
                        <hr />
                        ...
                        <div class="tab-content" id="profile-tabs">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="title"
                                            value="{{ isset($data['team']->title) ? $data['team']->title : old('title') }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="sub_title"
                                            value="{{ isset($data['team']->sub_title) ? $data['team']->sub_title : old('sub_title') }}"
                                    ...
                                    <div class="form-group">
                                        <div class="image dropify-wrapper">
                                            @if (!empty($data['team']->image))
                                                <img src="{{ asset($img_path . $data['team']->image) }}" alt=""
                            ...
                            <div class="tab-pane p-0 border-0 py-3" id="social-media-pane" role="tabpanel"
                                ...
                                <textarea name="description" class="form-control summernote" id="editor3">{{ isset($data['team']->description) ? $data['team']->description : old('description') }}</textarea>
                            </div>
                            ...
                            <div class="tab-pane p-0 border-0" id="banner-pane" role="tabpanel"
                                ...
                                <div class="col-md-12 mb-3 image">
                                    ...
                                    <div class="form-group">
                                        <div class="image dropify-wrapper">
                                            @if (!empty($data['team']->banner))
                                                <img src="{{ asset($img_path . $data['team']->banner) }}" alt=""
                                                    class="previewImage" width="30%">
                                            @else
                                                <img src="{{ asset('no_image.jpg') }}" alt=""
                                                    class="previewImage" width="30%">
                            ...
                            <div class="tab-pane p-0 border-0" id="reset-password-pane" role="tabpanel"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="seo_title"
                                            value="{{ isset($data['team']) ? $data['team']->seo_title : '' }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="seo_keyword"
                                            value="{{ isset($data['team']) ? $data['team']->seo_keyword : '' }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <textarea name="seo_description" value="" class="form-control" placeholder="Seo Description">{{ isset($data['team']) ? $data['team']->seo_description : '' }}</textarea>
                            ...
                            <button type="submit" data-button="page"
                                class="formButton  btn btn-{{ isset($data['team']) ? 'danger' : 'primary' }} text-center mx-auto btn-w-md d-flex align-items-center justify-content-center btn-wave waves-light text-nowrap waves-effect waves-light"
                                data-bs-toggle="modal" data-bs-target="#create-folder">
                                {!! isset($data['team']) ? '<i class="ri-edit-2-fill p-1"></i>' : '<i class="ri-add-large-fill p-1"></i>' !!}
                                {{ isset($data['team']) ? 'Update' : 'Create' }}
        ...
        <div class="modal fade" id="edit" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body render_team_edit">
...
@push('js')
    <script>
        $(document).ready(function() {
            //Status
            // $('.status_show_hide').on('click', function() {
            ...
            $(document).on('click', '.view-team', function() {
                ...
                // let url = "{{ route('admin.team.show', ':id') }}"; 
                // url = url.replace(':id', id);
                let url = "{{ url('/admin/team') }}/" + id;

                $.ajax({
                    url: url,
                    type: "GET",
                    success: function(resp) {
                        $('.render_team_show').html(resp);
                    },
                    error: function(xhr) {
