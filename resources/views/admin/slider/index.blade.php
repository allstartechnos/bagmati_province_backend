                ...
                <div class="modal fade" id="view" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body render_slider_show">
            ...
            <div class="card custom-card overflow-hidden border px-2">
                ...
                <form action="{{ route($base_route . 'store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-title">{!! isset($data['slider']) ? '<i class="ri-edit-2-fill"></i>' : '<i class="ri-add-large-fill"></i>' !!}
                            {{ isset($data['slider']) ? 'Update' : 'Create' }}
                            {{ $panel ?? '' }}(Page)</h6>
                        <hr />
                        ...
                        <div class="tab-content" id="profile-tabs">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="title"
                                            value="{{ isset($data['slider']->title) ? $data['slider']->title : old('title') }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="sub_title"
                                            value="{{ isset($data['slider']->sub_title) ? $data['slider']->sub_title : old('sub_title') }}"
                                    ...
                                    <div class="form-group">
                                        <div class="image dropify-wrapper">
                                            @if (!empty($data['slider']->image))
                                                <img src="{{ asset($img_path . $data['slider']->image) }}" alt=""
                            ...
                            <div class="tab-pane p-0 border-0 py-3" id="social-media-pane" role="tabpanel"
                                ...
                                <textarea name="description" class="form-control summernote" id="editor3">{{ isset($data['slider']->description) ? $data['slider']->description : old('description') }}</textarea>
                            </div>
                            ...
                            <div class="tab-pane p-0 border-0" id="banner-pane" role="tabpanel"
                                ...
                                <div class="col-md-12 mb-3 image">
                                    ...
                                    <div class="form-group">
                                        <div class="image dropify-wrapper">
                                            @if (!empty($data['slider']->banner))
                                                <img src="{{ asset($img_path . $data['slider']->banner) }}"
                            ...
                            <div class="tab-pane p-0 border-0" id="reset-password-pane" role="tabpanel"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="seo_title"
                                            value="{{ isset($data['slider']) ? $data['slider']->seo_title : '' }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="seo_keyword"
                                            value="{{ isset($data['slider']) ? $data['slider']->seo_keyword : '' }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <textarea name="seo_description" value="" class="form-control" placeholder="Seo Description">{{ isset($data['slider']) ? $data['slider']->seo_description : '' }}</textarea>
                            ...
                            <button type="submit" data-button="page"
                                class="formButton btn btn-{{ isset($data['slider']) ? 'danger' : 'primary' }} text-center mx-auto btn-w-md d-flex align-items-center justify-content-center btn-wave waves-light text-nowrap waves-effect waves-light"
                                data-bs-toggle="modal" data-bs-target="#create-folder">
                                {!! isset($data['slider']) ? '<i class="ri-edit-2-fill p-1"></i>' : '<i class="ri-add-large-fill p-1"></i>' !!}
                                {{ isset($data['slider']) ? 'Update' : 'Create' }}
        ...
        <div class="modal fade" id="edit" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body render_slider_edit">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-slider', function() {
                ...
                // let url = "{{ route('admin.slider.show', ':id') }}"; 
