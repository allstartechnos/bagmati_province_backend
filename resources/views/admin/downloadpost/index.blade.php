                            ...
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-hover">
                                        ...
                                        <tbody id="table_rows">
                                            @include('admin.downloadpost.table')
                                        </tbody>
                                    </table>
                                    {{-- //View Details --}}
                                </div>
                                ...
                                <div class="modal fade" id="view" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body render_downloadpost_show">
        ...
        <div class="modal fade" id="edit" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body render_downloadpost_edit">
                        ...
                        <form action="{{ route($base_route . 'store') }}" method="POST" class="row g-3 main_form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 mb-3">
                                    {{-- <label for="product-download-add" class="form-label">Category</label> --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.status_show_hide', function() {
                ...
                $.ajax({
                    url: "{{ route('admin.downloadpost.status') }}",
                    data: {
                        id: id
                    },
            ...
            $(document).on('click', '.view-page', function() {
                ...
                // let url = "{{ route('admin.downloadpost.show', ':id') }}"; 
                // url = url.replace(':id', id);
                let url = "{{ url('/admin/downloadpost') }}/" + id;

                $.ajax({
                    url: url,
                    type: "GET",
                    success: function(resp) {
                        $('.render_downloadpost_show').html(resp);
                    },
                    error: function(xhr) {
            ...
            $(document).on('click', '.edit-page', function() {
                ...
                let url = "{{ route('admin.downloadpost.edit', ':id') }}";
                url = url.replace(':id', id);
                // let url = "{{ url('/admin/downloadpost') }}/" + id;
                ...
                $.ajax({
                    ...
                    type: "GET",
                    success: function(resp) {
                        $('.render_downloadpost_edit').html(resp);
                        initializeCkEditor();
                        // $('#edit').modal('show');
                    },
                    error: function(xhr) {
