<form action="{{ route($base_route . 'update', $page->id) }}" method="POST" enctype="multipart/form-data"
    class="main_form">
    @csrf
    @method('PUT')
    ...
    <div class="col-xl-12 mb-3">
        ...
        <select name="parent_id" class="form-control">
            ...
            @forelse ($categories as $categories)
                <option value="{{ $categories->id }}" {{ $page->parent_id == $categories->id ? 'selected' : '' }}>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input type="text" name="title" class="form-control title" value="{{ $page->title ?? '' }}"
        ...
        <div class="col-md-6 mb-3">
            <div class="d-flex justify-content-between align-items-center image dropify-wrapper">
                ...
                <input name="image" class="form-control my-2 me-2 file-input custom-file-input" type="file"
                    id="formFile3">
                @if ($page->image)
                    <img src="{{ asset($img_path . $page->image) }}" width="20%" class="img-thumbnail previewImage">
                @else
        ...
        <div class="col-md-12 mb-3">
            <div class="form-floating">
                <input type="text" name="sub_title" class="form-control sub_title"
                    value="{{ $page->sub_title ?? '' }}" id="floatingName" placeholder="sub title">
