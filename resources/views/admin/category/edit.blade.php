<form action="{{ route($base_route . 'update', $category->id) }}" method="POST" enctype="multipart/form-data"
    class="main_form">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input type="text" name="title" class="form-control title" value="{{ $category->title ?? '' }}"
        ...
        <div class="col-md-6 mb-3">
            <div class="d-flex justify-content-between align-items-center image dropify-wrapper">
                ...
                <input name="image" class="form-control my-2 me-2 file-input custom-file-input" type="file"
                    id="formFile3">
                @if ($category->image)
                    <img src="{{ asset($img_path . $category->image) }}" width="20%"
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input type="text" name="sub_title" class="form-control sub_title"
                    value="{{ $category->sub_title ?? '' }}" id="floatingName" placeholder="sub title">
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input type="number" name="rank" class="form-control rank" value="{{ $category->rank ?? '' }}"
