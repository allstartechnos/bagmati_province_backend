                ...
                <div class="modal fade" id="view" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body render_document_show">
        ...
        <div class="col-lg-5">
            <div class="card custom-card overflow-hidden border px-2">
                {{-- @if (isset($data['document']))
                    <form action="{{ route($base_route . 'update', $data['document']->id) }}" method="POST"
                ...
                <form action="{{ route($base_route . 'store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-title">{!! isset($data['document']) ? '<i class="ri-edit-2-fill"></i>' : '<i class="ri-add-large-fill"></i>' !!}
                            {{ isset($data['document']) ? 'Update' : 'Create' }}
                            {{ $panel ?? '' }}(Page)</h6>
                        <hr />
                        ...
                        <div class="tab-content" id="profile-tabs">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="title"
                                            value="{{ isset($data['document']->title) ? $data['document']->title : old('title') }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="sub_title"
                                            value="{{ isset($data['document']->sub_title) ? $data['document']->sub_title : old('sub_title') }}"
                                    ...
                                    <div class="form-group">
                                        <div class="image dropify-wrapper">
                                            @if (!empty($data['document']->image))
                                                <img src="{{ asset($img_path . $data['document']->image) }}"
                            ...
                            <div class="tab-pane p-0 border-0 py-3" id="social-media-pane" role="tabpanel"
                                ...
                                <textarea name="description" class="form-control summernote" id="editor3">{{ isset($data['document']->description) ? $data['document']->description : old('description') }}</textarea>
                            </div>
                            ...
                            <div class="tab-pane p-0 border-0" id="banner-pane" role="tabpanel"
                                ...
                                <div class="col-md-12 mb-3 image">
                                    ...
                                    <div class="form-group">
                                        <div class="image dropify-wrapper">
                                            @if (!empty($data['document']->banner))
                                                <img src="{{ asset($img_path . $data['document']->banner) }}"
                                                    alt="" class="previewImage" width="30%">
                                            @else
                                                <img src="{{ asset('no_image.jpg') }}" alt=""
                                                    class="previewImage" width="30%">
                            ...
                            <div class="tab-pane p-0 border-0" id="reset-password-pane" role="tabpanel"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="seo_title"
                                            value="{{ isset($data['document']) ? $data['document']->seo_title : '' }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="seo_keyword"
                                            value="{{ isset($data['document']) ? $data['document']->seo_keyword : '' }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <textarea name="seo_description" value="" class="form-control" placeholder="Seo Description">{{ isset($data['document']) ? $data['document']->seo_description : '' }}</textarea>
                            ...
                            <button type="submit"data-button="page"
                                class="formButton btn btn-{{ isset($data['document']) ? 'danger' : 'primary' }} text-center mx-auto btn-w-md d-flex align-items-center justify-content-center btn-wave waves-light text-nowrap waves-effect waves-light"
                                data-bs-toggle="modal" data-bs-target="#create-folder">
                                {!! isset($data['document']) ? '<i class="ri-edit-2-fill p-1"></i>' : '<i class="ri-add-large-fill p-1"></i>' !!}
                                {{ isset($data['document']) ? 'Update' : 'Create' }}
        ...
        <div class="modal fade" id="edit" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body render_document_edit">
                    ...
                    <div class="modal-body">
                        <form action="{{ route($base_route . 'store') }}" method="POST" class="row g-3 main_form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-floating">
                                        <input type="number" name="rank" class="form-control sub_title"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.status_show_hide', function() {
                ...
                $.ajax({
                    url: "{{ route('admin.document.status') }}",
                    data: {
                        id: id
                    },
            ...
            $(document).on('click', '.view-document', function() {
                ...
                // let url = "{{ route('admin.document.show', ':id') }}"; 
                // url = url.replace(':id', id);
                let url = "{{ url('/admin/document') }}/" + id;

                $.ajax({
                    url: url,
                    type: "GET",
                    success: function(resp) {
                        $('.render_document_show').html(resp);
                    },
                    error: function(xhr) {
                        errorAlert(xhr.responseJSON?.document || 'Something went wrong');
                    }
                });
            });
            ...
            $(document).on('click', '.edit-document', function() {
                ...
                let url = "{{ route('admin.document.edit', ':id') }}";
                url = url.replace(':id', id);
                // let url = "{{ url('/admin/document') }}/" + id;
                ...
                $.ajax({
                    ...
                    type: "GET",
                    success: function(resp) {
                        $('.render_document_edit').html(resp);
                        // $('#edit').modal('show');
                        initializeCkEditor();
                    },
                    error: function(xhr) {
