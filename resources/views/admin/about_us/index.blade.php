    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            <div class="card custom-card overflow-hidden border px-2">
                {{-- @if (isset($data['about']))
                    <form action="{{ route($base_route . 'update', $data['about']->id) }}" method="POST"
                ...
                <form action="{{ route($base_route . 'store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="profile-tabs">
                            ...
                            <button type="submit"
                                class="btn btn-{{ isset($data['about']) ? 'danger' : 'primary' }} text-center mx-auto btn-w-md d-flex align-items-center justify-content-center btn-wave waves-light text-nowrap waves-effect waves-light"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-floating">
                                        <select name="banner" class="form-select">
                                            ...
                                            <option value="fas fa-bullseye">Bulls Eye</option>
                                            ...
                                            <option value="fas fa-thumbs-up">Thumps Up</option>
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            //             // SAFE toggle based on current class
            ...
            //         },
            //         error: function(err) {
            //             errorAlert('Status update failed');
            ...
            $(document).on('click', '.edit-about', function() {
                ...
                let url = "{{ route('admin.about.edit', ':id') }}";
                url = url.replace(':id', id);
                // let url = "{{ url('/admin/about') }}/" + id;
